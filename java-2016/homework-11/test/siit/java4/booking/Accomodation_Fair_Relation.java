...
public class Accomodation_Fair_Relation {

	int id;
	int id_accomodation;
	int id_room_fair;

	public Accomodation_Fair_Relation(int id, int id_accomodation, int id_room_fair) {
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Accomodation_Fair_Relation other = (Accomodation_Fair_Relation) obj;
		if (id != other.id)
			return false;
